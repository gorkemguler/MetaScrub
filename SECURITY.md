...
<https://github.com/gorkemguler/MetaScrub>, or by email to the address on
the repository owner's GitHub profile. Do not open a public issue for
anything that could expose users before a fix is out.

Please include: the MetaScrub version, how it was invoked (CLI / web /
...
MetaScrub processes untrusted files. Findings of interest include:
...
Out of scope: MetaScrub does not scrub document *body content* by design
