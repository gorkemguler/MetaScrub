<p align="center"><sub><a href="https://github.com/gorkemguler/MetaCLS/blob/main/ROADMAP.md">🇬🇧 English</a> · 🇹🇷 Türkçe</sub></p>
...
- **`metacls diff <runA> <runB>`**: iki çalıştırma raporunu (ya da
  dizinini) karşılaştırır: eklenen/silinen dosyalar ve (asıl mesele) iki
  çalıştırma arasında metadata *yeniden ortaya çıkan* dosyalar
