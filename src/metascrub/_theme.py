"""MetaScrub's own visual identity — one source of truth for the CSS used
by both the local web UI (`web.py`) and the HTML report
(`report/templates/`).

Deliberately *not* MetaScout's look. MetaScout is blue-on-black, dark
only. MetaScrub is emerald/slate with a "swept clean" motif and a proper
...
:root {
  ...
  --text:      #e9efed;
  --muted:     #93a5a0;
  --accent:    #2dd4a7;   /* emerald-teal — MetaScrub's signature */
  --accent-ink:#04140f;
  --link:      #5ad1c4;
  --good:      #2dd4a7;
  --warn:      #f6c454;
